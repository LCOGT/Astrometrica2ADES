...
class TestParseArgs(object):
    ...
    def test_parser_output_specified(self):
        ...
        input_file, output_file = parse_args(['MPCReport.txt', 'MPCReport_foo.psv'])
    ...
    def test_parser_path_input_no_output_specified(self):
        ...
        input_file, output_file = parse_args([os.path.join(path, 'MPCReport.txt')])
    ...
    def test_parser_path_input_output_specified(self):
        ...
        input_file, output_file = parse_args([os.path.join(in_path, 'MPCReport.txt'), os.path.join(out_path, 'MPCReport_foo.psv')])
